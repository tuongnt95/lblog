...
@section("content")
<form role="form" method="post" action="{{ route('permission.save') }}">
@csrf
<div class="card">
    <div class="card-body">
                ...
                @if (count($permissions))
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            @foreach ($roles as $role)
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="cb-{{ $role->id }}-{{ $permission->id }}" 
                            ...
                            <td class="text-center">
                                <a href="{{ route('permission.edit', $permission) }}" class="btn btn-icon"
